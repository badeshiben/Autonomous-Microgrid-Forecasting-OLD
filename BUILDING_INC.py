...
series = read_csv(r'C:\Users\rkhan\Documents\MIRACL\ARIMA_Forecasting_Python\Time_Series\Building\BP.csv',
...
split_point = len(series) - 1129 ## To start from 2001 datapoint
dataset, validation = series[0:split_point], series[split_point:1931]
input1 =series[1931:]
...
model = ARIMA(series, order=(5, 1, 3)).fit()
#model_fit = model.fit()
...
for t in range(len(test)):
    model = ARIMA(history, order=(5, 1, 3)).fit()
